...
function ServicePage() {
  return (
    <div className="max-w-full h-auto md:max-w-auto mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-center bg-gray-900">
        <div className="text-center md:text-left">
          <h1 className="font-sans md:font-serif text-4xl md:text-8xl font-bold text-white ml-4 md:ml-8 mt-10 md:mt-20">
            WHAT WE DO
          </h1>
