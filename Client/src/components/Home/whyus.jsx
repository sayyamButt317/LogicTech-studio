    ...
    <div class=" space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
        <a href="#" class="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            ...
            <div class="text-left rtl:text-right">
                <div class="-mt-1 font-sans text-sm font-semibold">ExpertTeam</div>
                <div class="mb-1 text-xs">Our Expert Team Delivers Custom Solution</div>
            </div>
        </a>
          ...
          className="lg:w-1/2 flex justify-center lg:justify-end mt-10 lg:mt-0">
            <img src={team} alt="" className="object-cover rounded-lg h-86 w-3/4 lg:w-full lg:h-[36rem]" />
          </div>
        </div>
      );
}
