      ...
      <div className='md:container md:mx-auto mt-10 h-full w-full bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 border border-gray-100'>
        <div className='flex flex-col lg:flex-row items-center justify-center m-12'>
          <div data-aos="fade-right"
            ...
            className="flex flex-col lg:flex-row items-center lg:items-start gap-24">
            <PersonImage />
            <div 
            data-aos="fade-left"
            data-aos-duration="700"className='mt-12 text-justify text-[3rem] font-serif font-semibold'>
              ...
              <button class="relative inline-flex items-center justify-center p-0.5 mt-4 mb-2 me-2 overflow-hidden text-sm font-medium text-white rounded-full group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 ">
